...
impl MuleInjector {
    ...
    pub fn generate(
        ...
        for cycle in 0..cycles {
            ...
            for i in 0..cashout_count {
                ...
                let (channel, category, counterparty, description) =
                    self.cashout_details(method);
    ...
    fn random_mule_source(&mut self) -> (TransactionChannel, CounterpartyRef) {
        ...
        match source_type {
            ...
            2 => (
                ...
                CounterpartyRef::international(&format!("Foreign Account {}", self.rng.gen::<u16>())),
            ),
            _ => (
    ...
    ) -> (TransactionChannel, TransactionCategory, CounterpartyRef, String) {
        match method {
            CashoutMethod::AtmWithdrawal => (
            ...
            CashoutMethod::InternationalWire => (
                ...
                CounterpartyRef::international(&format!("Overseas Account {}", self.rng.gen::<u16>())),
