...
impl OwnershipChain {
    ...
    pub fn add_intermediary(&mut self, intermediary: IntermediaryEntity) {
        ...
        let intermediary_pct: f64 = intermediary.ownership_percentage.try_into().unwrap_or(100.0);
        let current_effective: f64 = self.effective_ownership.try_into().unwrap_or(0.0);
        self.effective_ownership = Decimal::from_f64_retain(current_effective * intermediary_pct / 100.0)
...
mod tests {
    ...
    fn test_risk_scoring() {
        let base_owner = BeneficialOwner::new(
            Uuid::new_v4(),
            "Jane Doe",
            "US",
            Decimal::from(30),
        ...
        let pep_owner = BeneficialOwner::new(
            Uuid::new_v4(),
            "Minister Smith",
            "US",
            Decimal::from(30),
