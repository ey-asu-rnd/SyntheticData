...
use synth_core::models::banking::MerchantCategoryCode;
use uuid::Uuid;
...
impl CounterpartyGenerator {
    ...
    pub fn new(seed: u64) -> Self {
        Self {
            rng: ChaCha8Rng::seed_from_u64(seed.wrapping_add(3000)),
        }
    }
    ...
    fn generate_merchants(&mut self, pool: &mut CounterpartyPool, _config: &BankingConfig) {
        // Grocery stores
        let grocery_names = [
            "Walmart", "Kroger", "Costco", "Safeway", "Publix", "Whole Foods",
            "Trader Joe's", "Aldi", "Target Grocery", "Stop & Shop",
        ];
        ...
        let restaurant_names = [
            ...
            "Olive Garden", "Applebee's", "Taco Bell", "Wendy's", "Subway",
        ];
        ...
        // Gas stations
        let gas_names = ["Shell", "ExxonMobil", "Chevron", "BP", "Circle K", "7-Eleven"];
    ...
    fn generate_government_agencies(&mut self, pool: &mut CounterpartyPool) {
        let agencies = [
            ...
            ("Social Security Administration", GovernmentAgencyType::SocialSecurity),
