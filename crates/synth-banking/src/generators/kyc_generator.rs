...
impl KycGenerator {
    ...
    fn generate_retail_profile(
        &mut self,
        persona: synth_core::models::banking::RetailPersona,
    ) -> KycProfile {
    ...
    fn generate_business_profile(
        &mut self,
        persona: synth_core::models::banking::BusinessPersona,
    ) -> KycProfile {
    ...
    fn generate_trust_profile(
        &mut self,
        _persona: synth_core::models::banking::TrustPersona,
    ) -> KycProfile {
...
mod tests {
    ...
    fn test_kyc_generation() {
        ...
        .with_persona(PersonaVariant::Retail(
            synth_core::models::banking::RetailPersona::MidCareer,
        ));
