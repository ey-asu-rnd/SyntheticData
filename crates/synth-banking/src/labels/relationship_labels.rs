...
impl RelationshipLabelExtractor {
    ...
    fn from_customer_relationship(
        ...
        let rel_type = match relationship.relationship_type {
            CustRelType::Spouse | CustRelType::ParentChild | CustRelType::Sibling | CustRelType::Family
            ...
            CustRelType::Guarantor | CustRelType::Attorney
    ...
    pub fn extract_from_transactions(
        ...
        pairs
            ...
            .map(|((account_id, _counterparty), (count, volume, suspicious))| {
                let mut label = RelationshipLabel::new(
                    account_id,
...
mod tests {
    ...
    fn test_mule_link() {
        ...
        let label = RelationshipLabel::new(source, target, RelationshipType::Unknown).as_mule_link();
