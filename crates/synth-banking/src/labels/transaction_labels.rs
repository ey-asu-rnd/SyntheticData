...
use synth_core::models::banking::{AmlTypology, LaunderingStage};
use uuid::Uuid;
...
impl TransactionLabel {
    ...
    pub fn from_transaction(txn: &BankTransaction) -> Self {
        ...
        Self {
            ...
            features: TransactionLabelFeatures {
                ...
                is_cash: matches!(
                    txn.channel,
                    synth_core::models::banking::TransactionChannel::Cash
                ),
                is_international: matches!(
                    txn.category,
                    synth_core::models::banking::TransactionCategory::InternationalTransfer
                ),
    ...
    fn is_unusual_timing(txn: &BankTransaction) -> bool {
        ...
        matches!(weekday, chrono::Weekday::Sat | chrono::Weekday::Sun) || hour < 6 || hour > 22
    }
}
...
impl TransactionLabelExtractor {
    ...
    fn compute_rapid_succession(
        labels: &mut [TransactionLabel],
        transactions: &[BankTransaction],
    ) {
        ...
        for indices in by_account.values() {
            for window in indices.windows(2) {
                ...
                let duration = (t2.timestamp_initiated - t1.timestamp_initiated).num_minutes().abs();
                if duration < 30 {
...
mod tests {
    ...
    fn test_label_extraction() {
        ...
        let mut txn = BankTransaction::new(
            ...
            "USD",
            synth_core::models::banking::Direction::Inbound,
            synth_core::models::banking::TransactionChannel::Cash,
            synth_core::models::banking::TransactionCategory::CashDeposit,
