...
fn business_spending_profile(cash_intensity: f64, international_rate: f64) -> SpendingProfile {
    SpendingProfile {
        groceries: 0.00,
        dining: 0.05,
        entertainment: 0.03,
...
mod tests {
    ...
    fn test_business_profiles() {
        ...
        assert!(small.transaction_behavior.monthly_tx_count < enterprise.transaction_behavior.monthly_tx_count);
