...
use synth_core::models::documents::{GoodsReceipt, Payment, PurchaseOrder, VendorInvoice};
use synth_core::{AnomalyType, FraudType, LabeledAnomaly, ProcessIssueType};
...
mod tests {
    ...
    use synth_core::models::documents::{GoodsReceiptItem, PurchaseOrderItem, VendorInvoiceItem};
