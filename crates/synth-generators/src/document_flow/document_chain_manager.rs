...
pub struct JournalEntrySources {
    ...
    pub goods_receipts: Vec<synth_core::models::documents::GoodsReceipt>,
    /// Vendor invoices (DR Expense, CR AP)
    pub vendor_invoices: Vec<synth_core::models::documents::VendorInvoice>,
    /// AP payments (DR AP, CR Bank)
    pub ap_payments: Vec<synth_core::models::documents::Payment>,
    /// Deliveries (DR COGS, CR Inventory)
    pub deliveries: Vec<synth_core::models::documents::Delivery>,
    /// Customer invoices (DR AR, CR Revenue)
    pub customer_invoices: Vec<synth_core::models::documents::CustomerInvoice>,
    /// AR receipts (DR Bank, CR AR)
    pub ar_receipts: Vec<synth_core::models::documents::Payment>,
}
