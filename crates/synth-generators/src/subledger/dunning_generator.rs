...
use synth_core::models::subledger::SubledgerDocumentStatus;
...
impl DunningGenerator {
    ...
    pub fn execute_dunning_run(
        ...
        for (customer_id, customer_invoices) in customer_invoices.iter_mut() {
            ...
            for invoice in customer_invoices.iter_mut() {
                ...
                invoice
                    .dunning_info
                    .advance_level(run_date, run_id.clone());
            }
    ...
    pub fn generate_customer_summaries(&self, letters: &[DunningLetter]) -> Vec<CustomerDunningSummary> {
    ...
    pub fn generate_period_dunning_runs(
        ...
        while current_date <= end_date {
            let result =
                self.execute_dunning_run(company_code, current_date, invoices, currency);
            results.push(result);
...
mod tests {
    use super::*;
    use synth_core::models::subledger::ar::DunningRunStatus;
    use synth_core::models::subledger::{CurrencyAmount, PaymentTerms};
    ...
    fn test_dunning_charges_and_interest() {
        ...
        let mut invoices =
            vec![create_test_invoice("INV-001", "CUST001", invoice_date, due_date, dec!(1000))];
