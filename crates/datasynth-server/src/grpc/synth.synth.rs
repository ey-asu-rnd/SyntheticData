...
// This is a pre-generated version for systems without protoc.
...
impl ControlAction {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ControlAction::Unspecified => "CONTROL_ACTION_UNSPECIFIED",
            ControlAction::Pause => "PAUSE",
            ControlAction::Resume => "RESUME",
            ControlAction::Stop => "STOP",
            ControlAction::TriggerPattern => "TRIGGER_PATTERN",
        }
    }
...
pub mod synthetic_data_service_server {
    ...
    #[async_trait]
    pub trait SyntheticDataService: Send + Sync + 'static {
    ...
    /// Main service for synthetic data generation
    #[derive(Debug)]
    pub struct SyntheticDataServiceServer<T: SyntheticDataService> {
        inner: Arc<T>,
    ...
    impl<T: SyntheticDataService> SyntheticDataServiceServer<T> {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for SyntheticDataServiceServer<T>
    where
                ...
                "/synth.SyntheticDataService/BulkGenerate" => {
                        ...
                        for BulkGenerateSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as SyntheticDataService>::bulk_generate(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/synth.SyntheticDataService/StreamData" => {
                        ...
                        for StreamDataSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SyntheticDataService>::stream_data(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/synth.SyntheticDataService/GetConfig" => {
                        ...
                        for GetConfigSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SyntheticDataService>::get_config(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/synth.SyntheticDataService/SetConfig" => {
                        ...
                        for SetConfigSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SyntheticDataService>::set_config(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/synth.SyntheticDataService/GetMetrics" => {
                        ...
                        for GetMetricsSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SyntheticDataService>::get_metrics(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/synth.SyntheticDataService/HealthCheck" => {
                        ...
                        for HealthCheckSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SyntheticDataService>::health_check(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T: SyntheticDataService> Clone for SyntheticDataServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    impl<T: SyntheticDataService> tonic::server::NamedService
        for SyntheticDataServiceServer<T>
    {
        const NAME: &'static str = "synth.SyntheticDataService";
    }
}
