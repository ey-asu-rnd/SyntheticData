...
impl AmlTypology {
    ...
    pub fn category(&self) -> &'static str {
        match self {
            ...
            Self::RoundTripping | Self::TradeBasedML | Self::InvoiceManipulation => "Round-Tripping",
...
mod tests {
    ...
    fn test_laundering_stage() {
        assert!(LaunderingStage::Integration.detection_difficulty() > LaunderingStage::Placement.detection_difficulty());
    }

    #[test]
    fn test_sophistication_detectability() {
        assert!(Sophistication::Basic.detectability_modifier() > Sophistication::Professional.detectability_modifier());
    }
