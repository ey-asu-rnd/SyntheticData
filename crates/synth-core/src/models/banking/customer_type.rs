...
mod tests {
    ...
    fn test_retail_persona_properties() {
        ...
        assert!(max > min);
        assert!(RetailPersona::HighNetWorth.base_risk_score() > RetailPersona::Student.base_risk_score());
    }
    ...
    fn test_business_persona_properties() {
        ...
        assert!(BusinessPersona::MoneyServices.base_risk_score() > BusinessPersona::Enterprise.base_risk_score());
    }
}
